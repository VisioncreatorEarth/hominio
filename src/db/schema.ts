...
export const docs = pgTable('docs', {
    ...
    // Latest snapshot CID with foreign key constraint to prevent deletion of referenced content
    snapshotCid: text('snapshot_cid').notNull().references(() => content.cid, { onDelete: 'restrict' }),
