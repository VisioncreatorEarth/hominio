...
// Define the custom chain using defineChain
export const chronicle: Chain = {
    id: 175188,
    name: 'Chronicle Yellowstone - Lit Protocol Testnet',
    nativeCurrency: { name: 'Test LIT', symbol: 'tstLPX', decimals: 18 },
    rpcUrls: {
...
// PKP Permissions Contract Details for datil-dev
export const PKP_PERMISSIONS_CONTRACT_ADDRESS_DATIL_DEV =
    '0xf64638F1eb3b064f5443F7c9e2Dc050ed535D891' as Address;
...
// --- NEW: PKPNFT ABI Fragment for Transfer Event ---
export const PKP_NFT_ABI = [
    ...
    // Add other PKPNFT functions/events here if needed later
] as const;

// Address for the PKPNFT contract on Chronicle Yellowstone (datil-dev)
export const PKP_NFT_CONTRACT_ADDRESS_DATIL_DEV =
    '0x8F75CCe7Ce6052844114815463660a1dC1476A1A' as Address;

// --- PKPHelper Contract Details (datil-dev) ---
export const PKP_HELPER_CONTRACT_ADDRESS_DATIL_DEV =
    '0xCa9C62fB4ceA8831eBb6fD9fE747Cc372515CF7f' as `0x${string}`;
...
// --- Rate Limit NFT Contract Details (datil-dev / Chronicle Yellowstone) ---
export const RATE_LIMIT_NFT_CONTRACT_ADDRESS =
    '0x1A12D5B3D6A52B3bDe0468900795D35ce994ac2b' as Address;
